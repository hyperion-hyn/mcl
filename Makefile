...
$(BN256_LIB): $(BN256_OBJ) $(LIB_OBJ)
	$(AR) $@ $(BN256_OBJ) $(LIB_OBJ)

$(SHE256_LIB): $(SHE256_OBJ) $(LIB_OBJ)
	$(AR) $@ $(SHE256_OBJ) $(LIB_OBJ)

$(SHE384_LIB): $(SHE384_OBJ) $(LIB_OBJ)
	$(AR) $@ $(SHE384_OBJ) $(LIB_OBJ)

$(SHE384_256_LIB): $(SHE384_256_OBJ) $(LIB_OBJ)
	$(AR) $@ $(SHE384_256_OBJ) $(LIB_OBJ)
...
$(BN384_LIB): $(BN384_OBJ) $(LIB_OBJ)
	$(AR) $@ $(BN384_OBJ) $(LIB_OBJ)

$(BN384_256_LIB): $(BN384_256_OBJ) $(LIB_OBJ)
	$(AR) $@ $(BN384_256_OBJ) $(LIB_OBJ)

$(BN512_LIB): $(BN512_OBJ) $(LIB_OBJ)
	$(AR) $@ $(BN512_OBJ) $(LIB_OBJ)
